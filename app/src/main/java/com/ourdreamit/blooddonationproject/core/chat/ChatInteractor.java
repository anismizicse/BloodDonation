        ...
        databaseReference.child(Constants.ARG_CHAT_ROOMS).getRef().addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChild(room_type_1)) {
                    //Log.d("chatTrace","Inside sendMessageToFirebaseUser ChatInteractor room_type_1 "+room_type_1);
                    ...
                    //Log.d("chatTrace","Inside sendMessageToFirebaseUser ChatInteractor room_type_2 "+room_type_2);
...
//                                +"senderToken: "+new SharedPrefUtil(context).getString(Constants.ARG_FIREBASE_TOKEN)
...
//                );
    ...
    public void getMessageFromFirebaseUser(String senderUid, String receiverUid) {
        ...
        //Log.d("chatTrace","Inside sendMessageToFirebaseUser ChatInteractor getMessageFromFirebaseUser");
        ...
        databaseReference.child(Constants.ARG_CHAT_ROOMS).getRef().addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChild(room_type_1)) {
                    //Log.d("chatTrace","Inside sendMessageToFirebaseUser ChatInteractor getMessageFromFirebaseUser room_type_1 "+room_type_1);
                    ...
                    //Log.d("chatTrace","Inside sendMessageToFirebaseUser ChatInteractor getMessageFromFirebaseUser room_type_2 "+room_type_2);
