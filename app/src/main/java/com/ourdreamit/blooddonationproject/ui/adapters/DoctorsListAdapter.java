...
public class DoctorsListAdapter extends RecyclerView.Adapter<DoctorsListAdapter.DoctorsViewHolder> {
    ...
    public DoctorsListAdapter(Context ctx, List<UserInfo> list, FragmentManager manager) {
        context = ctx;
    ...
    public void addActiveDoctor(UserInfo user){
        Toast.makeText(context,"Doctor was added successfully",Toast.LENGTH_LONG).show();
        data.add(user);
            ...
            switch (v.getId()) {
                case R.id.call:
                    new AlertDialog.Builder(context,R.style.MyAlertDialogStyle)
                            ...
                            .setMessage("Are you sure to remove this Doctor?")
                            .setPositiveButton("Yes", new DialogInterface.OnClickListener() {

                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    removeDoctor(position);
                                    //deleteDoctorChat(DataLoader.getUserPhone(),DataLoader.activeDoctorDetails.get(adapterpos).phone);
                ...
                case R.id.details:
                    ...
                    AdminDoctorBasicInfo.doctor = true;
                    AdminDoctorBasicInfo.admin = false;
    ...
    private void removeDoctor(final int position) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                if(response.equals("doctor_removed")){
                    data.remove(position);
                    notifyItemRemoved(position);
                    notifyItemRangeChanged(position, data.size());
                    Toast.makeText(context,"Doctor was removed successfully.",Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(context,"Doctor was not removed.",Toast.LENGTH_LONG).show();
                }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("request_type", "doctor_remove");
                params.put("update_hotline", "na");
                params.put("update_ambulance", "na");
                params.put("doctor_phone", DataLoader.activeDoctorDetails.get(position).phone);
                return params;
            }
        };
